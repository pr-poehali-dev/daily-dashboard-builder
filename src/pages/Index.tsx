          ...
          {activeSection === 'tasks' && (
            <Card className="glass-card">
              ...
              <CardContent>
                <div className="space-y-3">
                  {tasks.map((task) => (
                    <div key={task.id} className="flex items-center gap-4 p-4 rounded-lg border hover:shadow-md transition-shadow">
            ...
            <Card className="glass-card">
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {habits.map((habit) => (
                    <div key={habit.id} className="p-6 rounded-xl border hover:shadow-lg transition-shadow">
                      ...
                      <Progress value={habit.progress} className="h-3 mb-2" />
                      <p className="text-sm text-muted-foreground text-right">{habit.progress}% за неделю</p>
                    </div>
                  ))}
                </div>
              </CardContent>
